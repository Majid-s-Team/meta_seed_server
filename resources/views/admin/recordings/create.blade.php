    ...
    <form method="POST" action="{{ route('admin.recordings.store') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required class="admin-input" placeholder="e.g. Match replay – Team A vs Team B">
            ...
            <div>
                ...
                <input type="url" name="video_url" value="{{ old('video_url') }}" placeholder="Or video URL" class="admin-input mt-2">
            ...
            <div>
                ...
                <input type="url" name="thumbnail_url" value="{{ old('thumbnail_url') }}" placeholder="Or thumbnail URL" class="admin-input mt-2">
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-[var(--meta-text-secondary)] text-sm font-medium mb-2">Recorded date</label>
                    <input type="date" name="recorded_at" value="{{ old('recorded_at') }}" class="admin-input">
                </div>
                <div>
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="checkbox" name="is_visible" value="1" {{ old('is_visible', true) ? 'checked' : '' }} class="rounded border-white/20 bg-white/5 text-[#6A5CFF]">
